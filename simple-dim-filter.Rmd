...
This example pulls the top 10 pages for the last thirty days, _for pages that have "adobe" in the page name_.* With the v4 API, filters are more powerful than v3, but (alas!) very basic filters can feel pretty convoluted. 
